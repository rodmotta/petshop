...
import static com.github.rodmotta.petshop.v2.core.shared.enums.Role.CUSTOMER;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers(POST, "/product").hasRole(Role.EMPLOYEE.name())
                        .requestMatchers(PUT, "/product/{productCode}").hasRole(Role.EMPLOYEE.name())
                        .requestMatchers(POST, "/product/{productId}/image").hasRole(Role.EMPLOYEE.name())
